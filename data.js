export const books = {
  ...
  'Tư duy Thành công & Phát triển Bản thân': [
    ...
    ['Hành trình đến thành công cho tuổi trẻ', 'Roger Leslie'] // [cite: 33, 48]
  ],
  ...
  'Văn học Kinh điển & Nuôi dưỡng Tâm hồn': [
    ...
    ['Những tấm lòng cao cả', 'Edmondo De Amicis'], // [cite: 21, 45]
    ['Mỉm cười cho qua', 'Hamlet Trương & Iris Cao'] // [cite: 27, 46]
  ],
  'Văn học Thanh xuân & Tình cảm': [
    ['Ngày xưa có một chuyện tình', 'Nguyễn Nhật Ánh'], // [cite: 1, 41]
    ['Ngôi trường mọi khi', 'Nguyễn Nhật Ánh'], // [cite: 8, 42]
    ['Khi lỗi thuộc về những vì sao', 'John Green'] // [cite: 14, 43]
  ]
};